...
return [
    ...
    */
    ...
    // This will be included in the email that you receive when you register
    'activate_account_url' => env('ACTIVATE_ACCOUNT_URL', 'http://localhost:8000/activate-account'),
